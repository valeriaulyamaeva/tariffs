...
$requirements = array(
    ...
    array(
        ...
        'by' => '<a href="https://www.yiiframework.com/doc-2.0/yii-caching-memcache.app">MemCache</a>',
        'memo' => extension_loaded('memcached') ? 'To use memcached set <a href="https://www.yiiframework.com/doc-2.0/yii-caching-memcache.app#$useMemcached-detail">MemCache::useMemcached</a> to <code>true</code>.' : ''
    ),
    // CAPTCHA:
    array(
        ...
        'mandatory' => false,
        'condition' => $gdOK,
        'by' => '<a href="https://www.yiiframework.com/doc-2.0/yii-captcha-captcha.app">Captcha</a>',
        'memo' => $gdMemo,
    ),
    array(
...
if (!version_compare(phpversion(), '5.5', '>=')) {
    $requirements[] = array(
        ...
        'by' => '<a href="https://www.yiiframework.com/doc-2.0/yii-caching-apccache.app">ApcCache</a>',
    );
}
